...
remote_control: ./src/main.o ./src/remote_controller.o ./src/lane_marker_detector.o ./src/udp_socket.o ./src/utility.o ./src/data_model.o ./src/fec.o ./src/packet_aggregator.o
