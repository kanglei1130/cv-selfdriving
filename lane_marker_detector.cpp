...
Points LaneMarkerDetector::getAllSet(vector<Points>& lanes, Point center) {
	int index = -1;
	int mxsize = 0;
	Points res;
...
Points LaneMarkerDetector::getLargestSet(vector<Points>& lanes, Point center) {
	int index = -1;
	int mxsize = 0;
	for(int i = 0; i < lanes.size(); ++i) {
		Points cur = lanes.at(i);
